    ...
    <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zM8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z"/>
      ...
      <span className="navbar-toggler-icon"></span>
        ...
        <div className="container">
            ...
            <h4>Definitions</h4>
            <p>Before understanding these definitions, please not that these definitons are not case sensitive. When we refer to as "we", "us" "curiopost" we are refering to the company "Curiopost". "Website" or "service" or "platform" refers to this service or the page where your reading this. "You" refers to you the person or human being who is currently reading this page. "Country" refers to Sri Lanka. "user", "profile", "acount" refers to you account which you registered, by providing a username, name, email and password. "personal data" refers to your data like your email, and "public data" refers to your public data like your username and name</p>
      
           <h4>Data that we collect</h4>
           <p>By default when you create a curiopost account we collect your: username, email, name, the hash of your password. You may add other forms of data by adding a bio, website, location, avatar and data you add through posts, questions, and replies.</p>
            
            <h4>Sharing your personal data</h4>
            <p>Curiopost doesn't sell or share your personal data unless required legally.</p>
            <h4>Use of your personal data</h4>
            <p style={{"marginBottom": "1%"}}>We may use your personal data to:</p>
            <ul>
                <li>
                    <p style={{"marginBottom": "0"}}>Verify that your a human being.</p>
                </li>
                <li>
                    <p style={{"marginBottom": "0"}}>Contact you or notify you about something if required.</p>
                </li>
                <li>
                    <p style={{"marginBottom": "0"}}>To know if you are the person you claim to say.</p>
                </li>
            </ul>
            <h4>Sharing your public data</h4>
            <p>Your public data is public and can be accessed by anyone, and is available everywhere.</p>
            <h4>Use of your public data</h4>
            <p>Your public data maybe used for:</p>
            <ul>
                <li>
                <p style={{"marginBottom": "0"}}>Displaying on your profile page.</p>
                </li>
                <li>
                <p style={{"marginBottom": "0"}}>Displaying on a post, or a question, or a reply.</p>
                </li>
                <li>
                <p style={{"marginBottom": "0"}}>Displaying on a search result, by a search engine on our inbuilt search.</p>
                </li>
            </ul>
            <h4>Deletion of you data</h4>
            <p>To delete all of your data that we hold, please headover to your account page, then scroll to the bottom and click on "delete account" and then enter your password and delete your account. We then would delete all of your data including personal data from our database.</p>
            <h4>Final</h4>
            <p>We reserve the right to update this privacy policy at any moment with or without any prior notice.</p>
            <hr/>
