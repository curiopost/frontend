...
<path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
      ...
      buffer(document.getElementById("registerbtn"), "Registering...")
       ...
       const rsp = await fetch(urls.backend+`/api/auth/register?r_key=${captcha_token}`, {
            method: "POST",
            headers: {
...
<p className="text-danger" id="bot-fail" style={{"marginBottom": "0%"}}></p>
            <button className=" btn btn-success w-100 text-center" id="registerbtn" style={{"marginBottom": "2%", marginTop: "2%"}} >Register</button>   
            </form>   
            <div className="text-center">
            <p  className="text-center text-muted " >Already have an account? <Link to="/login" className="text-success text-decoration-none">Login!</Link></p>
