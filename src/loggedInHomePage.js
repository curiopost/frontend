...
<textarea rows="3" class="form-control" id="post-content" maxLength={400} placeholder="Describe your post... You can @mention users and add #tags for topics."></textarea>
      </div>
      <div className="input-group mb-4 p-1">
