...
const udata = props.data
   const [feeds, setFeeds] = useState([<div><div className="card" aria-hidden="true" style={{"marginBottom": "1%"}}><div className="card-body"> <h5 className="card-title placeholder-glow col-6"> <span class="placeholder col-6"></span> </h5> <p className="card-text placeholder-glow"> <span class="placeholder col-7"></span> <span class="placeholder col-4"></span> <span class="placeholder col-4"></span> <span class="placeholder col-6"></span> <span class="placeholder col-8"></span> </p></div></div><div className="card" aria-hidden="true" style={{"marginBottom": "1%"}}><div className="card-body"> <h5 className="card-title placeholder-glow col-6"> <span class="placeholder col-6"></span> </h5> <p className="card-text placeholder-glow"> <span class="placeholder col-7"></span> <span class="placeholder col-4"></span> <span class="placeholder col-4"></span> <span class="placeholder col-6"></span> <span class="placeholder col-8"></span> </p></div></div><div className="card" aria-hidden="true" style={{"marginBottom": "1%"}}><div className="card-body"> <h5 className="card-title placeholder-glow col-6"> <span class="placeholder col-6"></span> </h5> <p className="card-text placeholder-glow"> <span class="placeholder col-7"></span> <span class="placeholder col-4"></span> <span class="placeholder col-4"></span> <span class="placeholder col-6"></span> <span class="placeholder col-8"></span> </p></div></div><div className="card" aria-hidden="true" style={{"marginBottom": "1%"}}><div className="card-body"> <h5 className="card-title placeholder-glow col-6"> <span class="placeholder col-6"></span> </h5> <p className="card-text placeholder-glow"> <span class="placeholder col-7"></span> <span class="placeholder col-4"></span> <span class="placeholder col-4"></span> <span class="placeholder col-6"></span> <span class="placeholder col-8"></span> </p></div></div><div className="card" aria-hidden="true" style={{"marginBottom": "1%"}}><div className="card-body"> <h5 className="card-title placeholder-glow col-6"> <span class="placeholder col-6"></span> </h5> <p className="card-text placeholder-glow"> <span class="placeholder col-7"></span> <span class="placeholder col-4"></span> <span class="placeholder col-4"></span> <span class="placeholder col-6"></span> <span class="placeholder col-8"></span> </p></div></div>
  ...
  <div className="card" aria-hidden="true" style={{"marginBottom": "1%"}}><div className="card-body"> <h5 className="card-title placeholder-glow col-6"> <span class="placeholder col-6"></span> </h5> <p className="card-text placeholder-glow"> <span class="placeholder col-7"></span> <span class="placeholder col-4"></span> <span class="placeholder col-4"></span> <span class="placeholder col-6"></span> <span class="placeholder col-8"></span> </p></div></div>
   ...
   useEffect(() => {
    const setTopics = async() => {
        ...
        const getTopics = await fetch(urls.backend+"/api/read/feeds", {
            method: "GET",
            headers: {
        ...
        const data = await getTopics.json()
...
bl.push(p)
        ...
        const getTaginTopicList = document.getElementById(topic)
        if(!getTaginTopicList) return;
        getTaginTopicList.classList.add('active')
    }
    ...
    const setTopicResults = async() => {
        const getPosts = await fetch(urls.backend+`/api/read/topics?topic=${topic}`, {
            method: 'GET'
        })
        ...
        if(data.success) {
            ...
            if(data.posts.length < 1) {
                return setFeeds([<div className="card"><div className="card-body"><br/><br/><br/><h3 className="card-title text-center">No Results found for '#{topic}'</h3><br/><br/><br/></div></div>])
            }
        ...
        data.posts.forEach(feed => {
            ...
            {feed.type.toLowerCase()}
              ...
              <div id="like-section" className="d-flex" style={{"cursor": "pointer", "marginLeft": "20px", "marginRight": "5px", "marginBottom": "0"}}>
                { feed.likes.includes(udata.raw_data._id) ?<div>
  ...
  {udata.raw_data.username === feed.username ? <><Link  to={"/"+feed.type.toLowerCase()+"s/"+feed._id+"/manage"} style={{"cursor": "pointer", "marginLeft": "6px",  }}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0d6efd" class="bi bi-pencil-square" viewBox="0 0 16 16">
