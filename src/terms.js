...
export default function Terms(props) {
    document.title = "Terms / Curiopost"
    ...
    <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zM8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z"/>
      ...
      <span className="navbar-toggler-icon"></span>
        ...
        <div className="container">
            ...
            <p>Last Update - 24/08/2022</p>
            </div>
            <hr/>

            <h4>Definitions</h4>
            <p>Before understanding these definitions, please not that these definitons are not case sensitive. When we refer to as "we", "us" "curiopost" we are refering to the company "Curiopost". "Website" or "service" or "platform" refers to this service or the page where your reading this. "You" refers to you the person or human being who is currently reading this page. "Country" refers to Sri Lanka. "user", "profile", "acount" refers to you account which you registered, by providing a username, name, email and password.</p>
      
            <h4>Requirements to use this platform</h4>
            <p>To use this platform i.e having a curiopost account, there are a few requirements, which you must fulfill. Failing to fulfill those requirements would mean that curiopost or anyone at curiopost(employee) will not be responsible for any form of harm or damage caused to you by using our platform.<br/> The requirements you have to fulfill:</p>
           <ul>
            <li>
                <p style={{"marginBottom": "0"}}>You must be 13 or above years old.</p>
            </li>
            <li>
            <p style={{"marginBottom": "0"}}>You must agree that you will not use this platform to bully, harass or do anything else that might be harmfull to an individual human being, or many.</p>
            </li>
            <li>
            <p style={{"marginBottom": "0"}}>The email you enter when registering an account must be yours, and, we require it to be verified, which we do by sending you a link.</p>
            </li>
            <li>
            <p style={{"marginBottom": "0"}}>You must agree that the content you add to curiopost, must not be nsfw content by any means.</p>
            </li>
            </ul>

            <h4>Our Rights</h4>
            <p>Curiopost always reserves the right to update, this terms of service and its privacy policy at any given moment without any prior notice. We also reserve the right to ban / delete / terminate your account and your content with or without providing a reason.</p>
            <h4>Your Agreement with Curiopost</h4>
            <p>This are the things that curiopost will be responsible and not for.</p>
            <ul>
            <li>
            <p style={{"marginBottom": "0"}}>Curiopost is provided to you "as is".</p>
            </li>
            <li>
            <p style={{"marginBottom": "0"}}>Curiopost is not responsible for accidents caused by natural disasters, power failures, or data breaches caused by our providers that are not "Curiopost".</p>
            </li>
            <li>
            <p style={{"marginBottom": "0"}}>You must agree to not take advantage of security vulnerabuilities if found, but you must email us about it immediately.</p>
            </li>
            <li>
            <p style={{"marginBottom": "0"}}>You must agree to not send high loads requests to our site or api with the intension of overloading or causing harm to our platform.</p>
            </li>
            </ul>

<h4>Your Data on Curiopost</h4>
<p>To know how you data is managed please read our <Link to="/privacy" className="text-decoration-none">privacy policy</Link>.</p>
<h4>Final</h4>
<p>To use curiopost you must agree to this terms of service, and our privacy policy and that both of these can be updated without any prior notice and that violating this and claiming that you didn't read this is not a valid reason.</p>
            <hr/>
